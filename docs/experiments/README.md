...
|----|--------|---------|----------|
| `e1_vllm` | **active** | [thesis](./e1_vllm_thesis.md) · [charter](./e1_vllm.md) | First slice: version fidelity, executable drift, intervention policy, and deterministic reconcile |
