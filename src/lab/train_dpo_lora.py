"""LoRA DPO trainer entrypoint (TRL DPOTrainer).

Config contract mirrors train_sft_lora.py:
  model, data.train_path, data.eval_path, output.dir, lora, training

Optional:
  training.module — set to lab.train_dpo_lora for Modal/Lambda dispatch
  training.beta   — DPO beta (default 0.1)
  training.max_length — tokenized sequence cap (default 1024)
"""
