...
from experiments.delta_v2 import (
    run_knowledge_stability_choice_preserved_rank0375_eval as base,
)
from experiments.delta_v2.run_knowledge_eval import _load_yaml


CONFIG_SCHEMA = "delta.knowledge_stability_choice_doubled_eval_config.v1"
PROTOCOL_SCHEMA = "delta.knowledge_stability_replay_eval_protocol.v1"
PROTOCOL_ID = "delta-v2-knowledge-stability-choice-doubled-eval-v1"
CONDITION_ID = "d15_stability_choice_doubled_eval"
RUN_ID = "delta-v2-d15-stability-choice-doubled-eval-modal-v1"
TRAINING_RUN_ID = (
    "delta-v2-d15-stability-choice-doubled-lora-qwen35-08b-modal-v1"
)
PROTOCOL_PATH = Path(
    "experiments/delta_v2/"
    "knowledge_stability_choice_doubled_eval_protocol.yaml"
)
...
TRIGGER = {
    ...
    "training_receipt_sha256":
        "078ac07e697bf189914a34e59e2d1b41c6b648f1b2bb7fa4ca08df5c871cd4f7",
    "training_metrics_sha256":
        "538ce726c032f2a70bbf8b0eb8b51985287003f25719be5a365044769ab5666f",
    "adapter_sha256":
        "01dddaab8e9b053b42ddcc6bfd2bb22b9e8877b5014f67110ff4cb3d77bc7b8f",
}
EVAL_MODULE = (
    "experiments.delta_v2."
    "run_knowledge_stability_choice_doubled_eval"
)
BASE_EVAL_MODULE = (
    "experiments.delta_v2."
...
def validate_config(
    ...
    if adjusted.get("eval", {}).get("module") != EVAL_MODULE:
        raise ValueError("d15 evaluation module changed")
