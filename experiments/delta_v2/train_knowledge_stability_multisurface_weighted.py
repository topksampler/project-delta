...
PROTOCOL_SCHEMA = (
    "delta.knowledge_stability_multisurface_weighted_lora_protocol.v1"
)
CONFIG_SCHEMA = (
    "delta.knowledge_stability_multisurface_weighted_lora_config.v1"
)
PROTOCOL_ID = (
    "delta-v2-knowledge-stability-multisurface-weighted-lora-v1"
)
CONDITION_ID = "d10_stability_multisurface_weighted_sft_control"
RUN_ID = (
...
PROTOCOL_PATH = Path(
    ...
    "knowledge_stability_multisurface_weighted_lora_protocol.yaml"
)
D9_TRAIN = "delta-v2-d9-stability-multisurface-lora-qwen35-08b-modal-v1"
D9_EVAL = "delta-v2-d9-stability-multisurface-eval-modal-v1"
EVIDENCE = {
    (D9_TRAIN, "run_receipt.json"):
        "9754524e590775ea1da8a9de81452a19382b592b43a29ac75e8282d9dd20af58",
    (D9_TRAIN, "train_metrics.json"):
        "c753afac00ebed075e383bdb3aaf7afffb26e052b0ce8439e72f951a3c337f3b",
    (D9_EVAL, "run_receipt.json"):
        "2a6c3b706ecbfbb97992a834965cbe07e1101962c3fbc74caabf0f94cd3df98e",
    (D9_EVAL, "metrics.json"):
        "0543f4411b28707f5cff6a6c269df0ec54594ae3ad1a89ffa30ae058ea9a2529",
}
DATA_BINDINGS = {
    "acquisition_train": (
        ACQUISITION_TRAIN_PATH,
...
def validate_config(
    ...
    if config.get("training") != {
        "module":
            "experiments.delta_v2."
            "train_knowledge_stability_multisurface_weighted",
        **OPTIMIZATION,
    }:
