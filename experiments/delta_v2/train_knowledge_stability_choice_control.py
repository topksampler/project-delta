...
from experiments.delta_v2.knowledge_stability_multisurface_choice_control_lora import (
    train_multisurface_choice_control_candidate,
)
...
D15_EVAL = "delta-v2-d15-stability-choice-doubled-eval-modal-v1"
EVIDENCE = {
    (D14_EVAL, "run_receipt.json"):
        "b68900cebb30cd4f7b89a3fff56e380e4a5bb7cf6b2674c3788120d19bf0921f",
    (D14_EVAL, "metrics.json"):
        "57fafe49540bd8e40216dab8ab0c4f8b423bd9ceef079324a75827a8f5781b71",
    (D15_EVAL, "run_receipt.json"):
        "0c44a3fb9ecc5d345eee2b78616da28577d0ec0d77ca3d19eca4623c58039ffa",
    (D15_EVAL, "metrics.json"):
        "0af5bf1a76fcb5957b2682d42b16871266ea9f49bc40a4d80e4f7d903e950a00",
}
...
SPECS = {
    "d16_stability_choice_weight4_sft_control": {
        "protocol_schema":
            "delta.knowledge_stability_choice_weight4_lora_protocol.v1",
        "config_schema":
            "delta.knowledge_stability_choice_weight4_lora_config.v1",
        "protocol_id":
            "delta-v2-knowledge-stability-choice-weight4-lora-v1",
        "run_id":
            "delta-v2-d16-stability-choice-weight4-lora-"
            "qwen35-08b-modal-v1",
        "protocol_path": Path(
            "experiments/delta_v2/"
            "knowledge_stability_choice_weight4_lora_protocol.yaml"
        ),
        "objective": {
            **BASE_OBJECTIVE,
            "objective_id":
                "generative-sft-plus-paired-ranking-choice-weight-v1",
            "choice_loss_weight": 4.0,
            "choice_format_ranking_weight": 0.0,
        },
    },
    "d17_stability_choice_format_rank_sft_control": {
        "protocol_schema":
            "delta.knowledge_stability_choice_format_rank_lora_protocol.v1",
        "config_schema":
            "delta.knowledge_stability_choice_format_rank_lora_config.v1",
        "protocol_id":
            "delta-v2-knowledge-stability-choice-format-rank-lora-v1",
        "run_id":
            "delta-v2-d17-stability-choice-format-rank-lora-"
            "qwen35-08b-modal-v1",
        "protocol_path": Path(
            "experiments/delta_v2/"
            "knowledge_stability_choice_format_rank_lora_protocol.yaml"
        ),
        "objective": {
            **BASE_OBJECTIVE,
            "objective_id":
...
def validate_config(
    ...
    if config.get("training") != {
        "module":
            "experiments.delta_v2."
            "train_knowledge_stability_choice_control",
        **OPTIMIZATION,
    }:
...
def train(config_path: Path, repo_root: Path) -> dict[str, Any]:
    ...
    return train_multisurface_choice_control_candidate(
