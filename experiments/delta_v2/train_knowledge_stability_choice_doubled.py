...
PROTOCOL_SCHEMA = (
    "delta.knowledge_stability_choice_doubled_lora_protocol.v1"
)
CONFIG_SCHEMA = (
    "delta.knowledge_stability_choice_doubled_lora_config.v1"
)
PROTOCOL_ID = "delta-v2-knowledge-stability-choice-doubled-lora-v1"
CONDITION_ID = "d15_stability_choice_doubled_sft_control"
RUN_ID = (
    "delta-v2-d15-stability-choice-doubled-lora-qwen35-08b-modal-v1"
)
DATASET_ID = "delta-v2-knowledge-stability-choice-preserved-v1"
PROTOCOL_PATH = Path(
    "experiments/delta_v2/"
    "knowledge_stability_choice_doubled_lora_protocol.yaml"
)
...
def validate_config(
    ...
    if config.get("training") != {
        "module":
            "experiments.delta_v2."
            "train_knowledge_stability_choice_doubled",
        **OPTIMIZATION,
    }:
