...
CONFIG_SCHEMA = (
    "delta.knowledge_stability_choice_format_weight4_eval_config.v1"
)
PROTOCOL_SCHEMA = "delta.knowledge_stability_replay_eval_protocol.v1"
PROTOCOL_ID = (
    "delta-v2-knowledge-stability-choice-format-weight4-eval-v1"
)
CONDITION_ID = "d18_stability_choice_format_weight4_eval"
RUN_ID = "delta-v2-d18-stability-choice-format-weight4-eval-modal-v1"
TRAINING_RUN_ID = (
...
PROTOCOL_PATH = Path(
    ...
    "knowledge_stability_choice_format_weight4_eval_protocol.yaml"
)
...
EVAL_MODULE = (
    "experiments.delta_v2."
    "run_knowledge_stability_choice_format_weight4_eval"
)
BASE_EVAL_MODULE = (
    "experiments.delta_v2."
...
def validate_config(
    ...
    if adjusted.get("eval", {}).get("module") != EVAL_MODULE:
        raise ValueError("d18 evaluation module changed")
