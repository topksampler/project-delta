...
PROTOCOL_SCHEMA = (
    "delta.knowledge_stability_choice_preserved_rank025_lora_protocol.v1"
)
CONFIG_SCHEMA = (
    "delta.knowledge_stability_choice_preserved_rank025_lora_config.v1"
)
PROTOCOL_ID = (
    "delta-v2-knowledge-stability-choice-preserved-rank025-lora-v1"
)
CONDITION_ID = "d13_stability_choice_preserved_rank025_sft_control"
RUN_ID = (
...
PROTOCOL_PATH = Path(
    ...
    "knowledge_stability_choice_preserved_rank025_lora_protocol.yaml"
)
D11_TRAIN = (
...
def validate_config(
    ...
    if config.get("training") != {
        "module":
            "experiments.delta_v2."
            "train_knowledge_stability_choice_preserved_rank025",
        **OPTIMIZATION,
    }:
