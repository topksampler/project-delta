...
CONFIG_SCHEMA = (
    "delta.knowledge_stability_choice_format_multineg_eval_config.v1"
)
PROTOCOL_SCHEMA = "delta.knowledge_stability_replay_eval_protocol.v1"
PROTOCOL_ID = (
    "delta-v2-knowledge-stability-choice-format-multineg-eval-v1"
)
CONDITION_ID = "d19_stability_choice_format_multineg_eval"
RUN_ID = "delta-v2-d19-stability-choice-format-multineg-eval-modal-v1"
TRAINING_RUN_ID = (
...
PROTOCOL_PATH = Path(
    ...
    "knowledge_stability_choice_format_multineg_eval_protocol.yaml"
)
...
TRIGGER = {
    ...
    "training_launch_commit": "fa20210",
...
EVAL_MODULE = (
    "experiments.delta_v2."
    "run_knowledge_stability_choice_format_multineg_eval"
)
BASE_EVAL_MODULE = (
    "experiments.delta_v2."
...
def validate_config(
    ...
    if adjusted.get("eval", {}).get("module") != EVAL_MODULE:
        raise ValueError("d19 evaluation module changed")
