...
from experiments.delta_v2.knowledge_stability_multisurface_rank0375_lora import (
    train_multisurface_rank0375_candidate,
)
...
PROTOCOL_SCHEMA = (
    "delta.knowledge_stability_choice_preserved_rank0375_lora_protocol.v1"
)
CONFIG_SCHEMA = (
    "delta.knowledge_stability_choice_preserved_rank0375_lora_config.v1"
)
PROTOCOL_ID = (
    "delta-v2-knowledge-stability-choice-preserved-rank0375-lora-v1"
)
CONDITION_ID = "d14_stability_choice_preserved_rank0375_sft_control"
RUN_ID = (
...
PROTOCOL_PATH = Path(
    ...
    "knowledge_stability_choice_preserved_rank0375_lora_protocol.yaml"
)
D12_EVAL = "delta-v2-d12-stability-choice-preserved-eval-modal-v1"
D13_EVAL = (
    "delta-v2-d13-stability-choice-preserved-rank025-eval-modal-v1"
)
EVIDENCE = {
    (D12_EVAL, "run_receipt.json"):
        "0e65a96c61bee43793df940f3375a7fceb90d3ad00e68b59046696fba7496a86",
    (D12_EVAL, "metrics.json"):
        "32fb86881fc0592e743f20db77dbd6a3f98c630e1250c41932cced68a8f2799b",
    (D13_EVAL, "run_receipt.json"):
        "185a1050edb749ef121638166e870a1e3ffb724ee471d49b092ef525467a6ee4",
    (D13_EVAL, "metrics.json"):
        "ccd4d795d7884d16ccbf5076d63b1e3b86953ae0fe1b6c17a2cf5864572de864",
}
...
def validate_config(
    ...
    if objective != {
        "objective_id": "generative-sft-plus-paired-ranking-v3",
    ...
    if config.get("training") != {
        "module":
            "experiments.delta_v2."
            "train_knowledge_stability_choice_preserved_rank0375",
        **OPTIMIZATION,
    }:
...
def train(config_path: Path, repo_root: Path) -> dict[str, Any]:
    ...
    return train_multisurface_rank0375_candidate(
